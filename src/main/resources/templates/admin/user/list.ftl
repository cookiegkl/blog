                                            ...
                                            <#if row.id != 1>
                                                <#if row.status == 0>
                                                    <a href="javascript:void(0);" class="btn btn-xs btn-default"
                                                       data-id="${row.id}" data-action="close">关闭</a>
                                                <#else>
                                                    <a href="javascript:void(0);" class="btn btn-xs btn-success"
                                                       data-id="${row.id}" data-action="open">激活</a>
                                                </#if>
                                                <a href="${base}/admin/user/pwd?id=${row.id}"
                                                   class="btn btn-xs btn-success">修改密码</a>

                                                <a href="${base}/admin/user/view?id=${row.id}"
                                                   class="btn btn-xs btn-primary">修改角色</a>
                                            <#else>
